...
- **17 Diagram Types** — covers the full project lifecycle
- **5 Color Themes** — Ocean Blue, Dark Night, Forest Green, Sunset Orange, Monochrome
- **4-Layer Business Standard Model** — L1 Core / L2 Supporting / L3 Common / L4 Process
- **Automated Layout** — fill formulas + 余量分配法 for uniform module distribution
- **Quality Checklist** — anti-overlap, content density, anti-pattern self-verification
...
| 17 | Comparison | `comparison` | Before/After or A/B comparison |
...
# Generate all 17 diagrams for a project
/drawio-arch all
...
- **4 层业务标准模型** — L1 核心 / L2 支撑 / L3 通用 / L4 流程
- **自动布局** — 均分填充公式 + 余量分配法，模块等宽等距
- **质量检查清单** — 防重叠、内容密度、反模式自检
...
| 17 | 方案对比图 | `comparison` | Before/After 或 A/B 对比 |
...
|-------------|-------|----------|
| [ocean-blue](./examples/ocean-blue/) | 16 | 全部 17 种图表类型 |
